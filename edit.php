...
<body>
	...
	<div class="container" style="margin-top:20px">
		...
		if (isset($_GET['npm'])) {
			...
			$select = mysqli_query($link, "SELECT * FROM biodata_mahasiswa WHERE npm='$npm'") or die(mysqli_error($link));
		...
		if (isset($_POST['submit'])) {
			...
			$sql = mysqli_query($link, "UPDATE biodata_mahasiswa SET npm='$npm', nama='$nama', tempat_lahir='$tempat', 
